...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeInputUser, TypeInputChannel, TypeBool, TypeChannelParticipantsFilter, TypeInputMessage, TypeChannelAdminRights, TypeChannelBannedRights, TypeInputStickerSet

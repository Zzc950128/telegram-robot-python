...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputBotInlineMessageID, TypeBool, TypeInputEncryptedChat, TypeInputGeoPoint, TypeInputDialogPeer, TypeInputMessage, TypeMessagesFilter, TypeInputUser, TypeInputSingleMedia, TypeReplyMarkup, TypeInputEncryptedFile, TypeShippingOption, TypeInputStickerSet, TypeInputStickeredMedia, TypeSendMessageAction, TypeMessageEntity, TypeInputMedia, TypeInputBotInlineResult, TypeInputChatPhoto, TypeInlineBotSwitchPM, TypeReportReason, TypeInputDocument, TypeInputPeer

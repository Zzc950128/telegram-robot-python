...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeImportedContact, TypeContactLink, TypePeer, TypeContact, TypeTopPeerCategoryPeers, TypePopularContact, TypeContactBlocked, TypeChat, TypeUser

...
if TYPE_CHECKING:
    ...
    from ...tl.types import TypeEncryptedFile, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeChatFull, TypeFoundGif, TypeDocument, TypeMessage, TypeStickerPack, TypeHighScore, TypeDialog, TypeChat, TypeStickerSet, TypeUser, TypeStickerSetCovered
